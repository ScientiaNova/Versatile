...
val ALLOY = MatProperty("versatile:alloy".toResLoc()) { false }
...
val LIQUID_COLOR = MatProperty("versatile:liquid_color".toResLoc()) { color }
...
val CHEMICAL_GROUP = MatProperty("versatile:chemical_group".toResLoc()) { false }
