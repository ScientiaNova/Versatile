...
open class StandardRecipeBasedMachine(recipeList: IRecipeLIst, properties: Properties, name: String = recipeList.name.toString()) : AbstractMachineBlock(properties, name) {
    init {
