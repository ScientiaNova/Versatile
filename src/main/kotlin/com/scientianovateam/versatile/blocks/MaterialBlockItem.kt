...
open class MaterialBlockItem(override val mat: Material, override val objType: Form) : BlockItem(MaterialBlocks[mat, objType]!!, objType.itemProperties(mat)), IMaterialObject {
    init {
