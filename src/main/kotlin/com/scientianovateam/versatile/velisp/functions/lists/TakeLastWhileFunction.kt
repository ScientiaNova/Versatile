...
object TakeLastWhileFunction : IFunction {
    override val name = "versatile/take_last_while"
    ...
    override fun evaluate(inputs: List<IUnresolved>): IEvaluated {
        ...
        return ListValue((inputs.first().evaluate() as ListValue).value.takeLastWhile { function.evaluate(listOf(it)) == BoolValue.TRUE })
    }
}