...
object TakeWhileFunction : IFunction {
    override val name = "versatile/take_while"
    ...
    override fun evaluate(inputs: List<IUnresolved>): IEvaluated {
        ...
        return ListValue((inputs.first().evaluate() as ListValue).value.takeWhile { function.evaluate(listOf(it)) == BoolValue.TRUE })
    }
}