...
object AllFunction : IFunction {
    override val name = "versatile/all"
    ...
    override fun evaluate(inputs: List<IUnresolved>): IEvaluated {
        ...
        return BoolValue((inputs.first().evaluate() as ListValue).value.all { function.evaluate(listOf(it)) == BoolValue.TRUE })
    }
}