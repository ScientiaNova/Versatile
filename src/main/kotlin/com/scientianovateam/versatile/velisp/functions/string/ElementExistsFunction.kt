...
object ElementExistsFunction : IFunction {
    override val name = "versatile/element_exists"
    override val inputCount = 1..1
    override fun evaluate(inputs: List<IUnresolved>) = ((inputs[0] as IUnevaluated).evaluate().value.toString() in ELEMENTS).expr()
}