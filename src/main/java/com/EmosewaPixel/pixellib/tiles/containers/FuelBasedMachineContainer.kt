...
class FuelBasedMachineContainer(playerInventory: PlayerInventory, te: FuelBasedTE, type: ContainerType<*>, id: Int) : RecipeBasedMachineContainer<RecipeBasedTE>(playerInventory, te, type, id) {
