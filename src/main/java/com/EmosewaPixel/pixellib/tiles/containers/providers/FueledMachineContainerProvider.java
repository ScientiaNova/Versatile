...
public class FueledMachineContainerProvider extends MachineContainerProvider {
    public FueledMachineContainerProvider(BlockPos pos, ResourceLocation name, ContainerType<?> containerType) {
        super(pos, name, containerType);
    }

    @Override
    public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        return new FuelBasedMachineContainer(playerInventory, (FuelBasedTE) playerEntity.world.getTileEntity(pos), containerType, id);
    }
}