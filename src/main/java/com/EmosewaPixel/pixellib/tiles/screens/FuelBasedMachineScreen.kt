...
class FuelBasedMachineScreen(container: FuelBasedMachineContainer, playerInventory: PlayerInventory, te: FuelBasedTE, backGround: String, textComponent: ITextComponent) : RecipeBasedMachineScreen<FuelBasedTE>(container, playerInventory, te, backGround, textComponent) {
