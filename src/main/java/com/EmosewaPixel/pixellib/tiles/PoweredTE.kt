...
class PoweredTE(type: TileEntityType<*>, recipeList: EnergyRecipeList, protected var maxPower: Int, protected var maxPowerIn: Int) : AbstractRecipeBasedTE<EnergyMachineRecipe>(type, recipeList), IEnergyStorage {
