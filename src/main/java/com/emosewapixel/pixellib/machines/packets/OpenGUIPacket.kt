...
class OpenGUIPacket(val pos: BlockPos, val containerType: ContainerType<*>) {
    ...
    companion object {
        fun decode(buffer: PacketBuffer) = OpenGUIPacket(buffer.readBlockPos(), ForgeRegistries.CONTAINERS.getValue(buffer.readResourceLocation())!!)
