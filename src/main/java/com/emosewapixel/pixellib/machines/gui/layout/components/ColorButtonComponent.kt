...
open class ColorButtonComponent(val property: ILimitedIntegerProperty, val texture: GUITexture, val colors: IntArray, override var x: Int, override var y: Int) : IGUIComponent {
