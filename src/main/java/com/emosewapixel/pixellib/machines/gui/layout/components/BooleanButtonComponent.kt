...
open class BooleanButtonComponent(val property: IVariableProperty<Boolean>, val texture: ButtonTextureGroup, override var x: Int, override var y: Int) : IGUIComponent {
    override var width = 16
    override var height = 16

    @OnlyIn(Dist.CLIENT)
    override fun drawInBackground(mouseX: Double, mouseY: Double, xOffset: Int, yOffset: Int, guiLeft: Int, guiTop: Int) = texture.render(xOffset + x, yOffset + y, width, height, drawMode = when {
